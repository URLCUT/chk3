        $(document).ready(function () {
            $("#iniciar").click(function () {
                ...
                $("#status").html('Prueba iniciada con exito <i class="fa fa-check" aria-hidden="true"></i>');
                executar = true;
                iniciar();
            });
        ...
        function startchk(url,ci,co,st,cod) {

            $.ajax({

                url: 'api.php',
                type: 'GET',
                data: 'lista=' + url + '&city=' + ci + '&country=' + co + '&state=' + st + '&zipcode=' + cod ,
